    ...
    <div className="flex-1 flex flex-col overflow-hidden">
      <div className="p-4 border-b border-gray-200 dark:border-gray-700">
        <button
          ...
          className="w-full px-4 py-2 bg-apple-blue text-white rounded-lg font-medium hover:bg-blue-600 transition-colors"
        >
          + Создать чат
        </button>
      </div>
...
const ChatItem = memo(({
  ...
  <motion.button
    onClick={onSelect}
    className={`w-full text-left p-4 hover:bg-gray-50 dark:hover:bg-gray-700 transition-colors relative ${
      isSelected ? 'bg-blue-50 dark:bg-blue-900 border-l-4 border-apple-blue' : ''
    ...
    <div className="flex items-center gap-3">
      ...
      <div className="flex-1 min-w-0">
        ...
        {lastMessage ? (
          ...
          <p className="text-sm text-gray-500 dark:text-gray-400 truncate">{partnerEmail}</p>
        ) : (
          <p className="text-sm text-gray-500 dark:text-gray-400 truncate">Нет сообщений</p>
        )}
      </div>
